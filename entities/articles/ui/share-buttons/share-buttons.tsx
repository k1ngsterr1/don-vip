...
export const ShareButtons = ({ title, url, locale }: ShareButtonsProps) => {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <a
        ...
        title={locale === "ru" ? "Поделиться в Twitter" : "Share on Twitter"}
      >
      ...
      <a
        ...
        title={locale === "ru" ? "Поделиться в Facebook" : "Share on Facebook"}
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <a
        ...
        title={locale === "ru" ? "Поделиться в LinkedIn" : "Share on LinkedIn"}
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <a
        ...
        rel="noopener noreferrer"
        className="flex items-center justify-center w-10 h-10 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors"
        title={locale === "ru" ? "Поделиться в Telegram" : "Share on Telegram"}
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
