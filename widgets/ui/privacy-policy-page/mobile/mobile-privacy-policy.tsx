  ...
  return (
    <div className="w-full px-[11px] mt-[24px] flex flex-col items-start md:hidden">
      ...
      <span className="text-[13px] text-left text-dark mt-[12px] font-roboto">
        ...
        оферты, размещенной на сайте в сети Интернет по адресу: www.don-vip.com
        (далее - Сайт).
        <br />
        <br />
        Сервисы Сайта - интерактивные (диалоговые) программные компоненты на
        страницах Сайта, используемые для интеграции с информационными системами
        и предоставляющие пользователям Сайта определенные возможности по
        доступу к информации на Сайте, а именно: к личному аккаунту (далее -
        ...
        <br />
        <br />
        1.1.2. Настоящая Политика конфиденциальности применяется только к Сайту
        www.don-vip.com. Сайт www.don-vip.com не контролирует и не несет
        ответственности за сайты третьих лиц, на которые Пользователь может
        перейти по ссылкам, доступным на Сайте www.don-vip.com.
        <br />
        <br />
        <strong>2. ЦЕЛИ ОБРАБОТКИ ПЕРСОНАЛЬНОЙ ИНФОРМАЦИИ ПОЛЬЗОВАТЕЛЕЙ</strong>
        <br />
        <br />
        ...
        срок, не превышающий 10 рабочих дней с момента получения. Уведомление об
        отзыве согласия на обработку персональных данных направляется на адрес
        электронной почты: hoyakap@gmail.com.
        <br />
        <br />
        2.2. Персональную информацию Пользователя Сайт обрабатывает в следующих
        целях:
        <br />
        <br />
        ...
        <br />
        <br />
        2.2.2. Установления с Пользователем обратной связи, включая направление
        уведомлений, запросов, касающихся использования Сайта, оказания услуг,
        обработку запросов и заявок от Пользователя.
        <br />
        <br />
        2.2.3. Предоставления Пользователю эффективной клиентской и технической
        ...
        <br />
        <br />
        3.1. Сайт хранит персональную информацию Пользователей и не передает её
        третьим лицам.
        <br />
        <br />
        3.2. В случае продажи Сайта к приобретателю переходят все обязательства
        ...
        персональных данных, в том числе в информационных системах персональных
        данных с использованием средств автоматизации или без использования
        таких средств. Обработка персональных данных Пользователей
        ...
        <br />
        <br />
        6.2. Получатель претензии в течение 10 календарных дней со дня получения
        ...
        Публичной оферты и Соглашения об использовании Сайта, размещенных на
        странице по адресу: www.don-vip.com
      </span>
    </div>
  );
}
